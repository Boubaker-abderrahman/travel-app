...
const Guide = () => {
  return (
    <section className="flex items-start justify-center flex-col h-screen  xl:mt-96">
      ...
      <div className="flex items-center justify-center mx-auto max-w-[1440px] relative w-full md:px-6 " >
        <Image 
          src="/boat.png"
          alt="boat"
          width={1440}
